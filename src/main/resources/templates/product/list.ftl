...
<#--&lt;#&ndash;                                    <a href="/sell/seller/product/off_sale?productId=${productInfo.productId}">下架</a>&ndash;&gt;-->
<#--                                    <a href="#">下架</a>-->
<#--                                <#else>-->
<#--&lt;#&ndash;                                    <a href="/sell/seller/product/on_sale?productId=${productInfo.productId}">上架</a>&ndash;&gt;-->
<#--                                    <a href="#">上架</a>-->
<#--                                </#if>-->
                            </td>
                        </tr>
